 ...
 * @method int docid() Real ID in XSDocument system
 * @method int rank() The rank in the search result
 * @method int percent()
 * @method float weight()
 * @method int ccount()
...
class ActiveRecord extends BaseActiveRecord
{
     ...
     *
     * This returns Database class instance,
     * however, you can also use methods in \XS|\XSIndex|\XSSearch.
     *
     * @return Database|\XS|\XSIndex|\XSSearch
     */
