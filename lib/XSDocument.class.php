 ...
 * 提交前后的行为
 *
 * @method int docid() 取得搜索结果文档的 docid 值 (实际数据库的id)
 * @method int rank() 取得搜索结果文档的序号值, 第X条结果
 * @method int percent() 取得搜索结果文档的匹配百分比, 结果匹配度, 1~100
 * @method float weight() 取得搜索结果文档的权重值, 浮点数
 * @method int ccount() 取得搜索结果折叠的数量, 按字段折叠搜索时
 * @method array matched() 取得搜索结果文档中匹配查询的词汇, 数组
 *
