...
class XSSearch extends XSServer
{
     ...
     * This has to be called before [[setQuery]]
     ...
     * @throws XSException
     */
    public function addQueryString($query, $addOp = XS_CMD_QUERY_OP_AND, $scale = 1.0)
    {
     ...
     * @see addQueryString
     */
    public function addQueryTerm($field, $term, $addOp = XS_CMD_QUERY_OP_AND, $scale = 1.0)
    {
